                        ...
                        <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0;" align="center" width="570" cellpadding="0" cellspacing="0">
                           <tr>
                              <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                 ...
                                 <!-- Intro -->
                                 <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">We noticed that you need to verify your email address in order to complete the Touru application registration. To do so, simply click on link below.</p>
                                 <!-- Action Button -->
                                 ...
                                 <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                    Once you verify it your registration will be completed with the Touru
                                 </p>
                                 <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                           ...
                           <tr>
                              <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                 <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                    ...
                                    <a style="color: #3869D4;" href="#" target="_blank">TourU</a>.
                                    All rights reserved.
                                 </p>
                              </td>
                           </tr>
